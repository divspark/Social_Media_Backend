...
router.put("/update-profile", middlewares_1.verifyToken, upload.single("file"), (0, middlewares_1.checkFeatureAccess)("profileUpdate"), authController_1.updateOwnProfile);
//Get current user profile
router.get("/get-profile", middlewares_1.verifyToken, authController_1.getOwnProfile);
//Admin ↔ User profile by UID
router.get("/getProfileById/:uid", middlewares_1.verifyToken, authController_1.getUserProfileByUID);
router.post("/saveFcmToken", middlewares_1.verifyToken, authController_1.saveFcmToken);
// Block / Unblock user
router.post("/block", middlewares_1.verifyToken, middlewares_1.requireAdmin, authController_1.blockOrUnblockUser);
// Get all blocked users
router.get("/getAllblockedUser", middlewares_1.verifyToken, middlewares_1.requireAdmin, authController_1.getBlockedUsers);
